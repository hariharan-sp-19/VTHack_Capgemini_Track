...
##                            MAIN SCRIPT                                   ##
##############################################################################
def findCO2FootPrint(email,answer_1,answer_2,answer_3,answer_4,answer_5,answer_6,answer_7,answer_8,answer_9,answer_10,answer_11,generateGraph=True,askInput=True,):
    if askInput:
    ...
    processedDataWithActions = {
        'User':data['email'],
        'electric (kg Co2/year)': footprintbytype[0],
        'flight (kg Co2/year)': footprintbytype[1],
        'transportation (kg Co2/year)': footprintbytype[2],
        'food (kg Co2/year)': footprintbytype[3],
        'retail (kg Co2/year)': footprintbytype[4],
        'Total Co2 Footprint':data['footprint'],
        'Conclusion':"",
    ...
    data['individual_means']=individual_means
    if generateGraph:
        make_graphs(individual_means, footprintbytype)

    return processedDataWithActions